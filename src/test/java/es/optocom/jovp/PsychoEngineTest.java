...
public class PsychoEngineTest {
  ...
  static class LogicWorld implements PsychoLogic {
    ...
    @Override
    public void init(PsychoEngine psychoEngine) {
      Item leftEye = new Item(new Model("/Users/imarinfr/06.optocom/03.software/jovp/src/test/resources/es/optocom/jovp/models/eyeball.obj"), new Texture(new double[] {1, 1, 1, 1}));
      Item rightEye = new Item(new Model("/Users/imarinfr/06.optocom/03.software/jovp/src/test/resources/es/optocom/jovp/models/eyeball.obj"), new Texture(new double[] {1, 1, 1, 1}));
